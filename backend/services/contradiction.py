...
async def check_contradictions(memory_id: str, embedding: list[float], user_id: str, db: AsyncSession):
    ...
    for i, cand_id in enumerate(candidate_ids):
        ...
        nli_result = await asyncio.to_thread(nli_predict, new_memory.content, cand_memory.content)
        ...
        if nli_result["label"] == "contradiction":
            ...
            await manager.broadcast("contradiction_detected", {
